...
class MultiProcessor():
    ...
    def process_file_neo4j(self, file, schemas, ds, db_conn):
        ...
        neo_driver = writer.create_and_set_neo4j_database(driver, ds)
        ...
        with multiprocessing.Pool() as write_pool:
            write_pool.map(writer.write_chunk_neo4j, [(chunk, neo_driver, ds, idx) for idx, chunk in enumerate(df_chunks)])
